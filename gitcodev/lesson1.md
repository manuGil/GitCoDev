...
#### EXERCISE 1: [Tracking changes with the Index](./exercises/L1-ex01.md)
...
```shell
    ...
    ls -FR
```
#### EXERCISE 2: [Stop tracking Changes in a File](./exercises/L1-ex02.md)
...
```shell
    ...
    git status -u
```
#### EXERCISE 3: [Renaming Tracked Files](./exercises/L1-ex03.md)
...
#### EXERCISE 4: [Renaming Tracked Files](./exercises/L1-ex04.md)
...
```shell
    ...
    git log
```
#### EXERCISE 5: [Follow the state of the repository in the commit routine](./exercises/L1-ex05.md)
```shell
...
#### EXERCISE 6: [Follow the state of the index in the commit routines](./exercises/L1-ex06.md)
...
#### EXERCISE 7: [Explore the changes recorded in the history](./exercises/L1-ex07.md)
...
#### EXERCISE 9: [Add lightweight tags to the history](./exercises/L1-ex09.md)
...
> A short wrap up about what has been learn.
